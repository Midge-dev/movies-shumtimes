...
// AndroidTokenStore keeps its own DataStore (plex_token) for the encrypted
// blob + IV — separate storage from ObservableSettings, so it takes the
// Context directly rather than routing through observableSettings() above.
