...
import com.reelay.tv.data.plex.PlexResource
...
import com.reelay.tv.ui.common.RelayStatus
import com.reelay.tv.ui.common.RelayStatusDot
import com.reelay.tv.ui.common.RelayStatusLine
...
import com.reelay.tv.ui.kit.FilterChip
...
import com.reelay.tv.ui.kit.Switch
...
fun SettingsScreen(
    ...
    Row(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            Text("Settings", style = Typography.displaySmall)
            ...
            Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                ...
                FocusableSurface(
                    ...
                    colors = Colors(container = AppBackground, content = AppOnSurfaceVariant, focusedContent = AppWhite),
                    border = Border(idle = BorderStroke(2.dp, AppDimBorder), focused = BorderStroke(2.dp, NeonPurpleGradient)),
...
private fun RelaySettingsPane(
    ...
    Row(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            Text("Relay settings", style = Typography.displaySmall)
            Text(
        ...
        Column(
            ...
            options.forEachIndexed { index, value ->
                ...
                FocusableSurface(
                    ...
                    border = Border(focused = BorderStroke(2.dp, NeonPurpleGradient)),
                    glow = Glow(focusedColor = NeonPurpleGlow),
                    contentAlignment = Alignment.CenterStart,
                ) {
                    Row(
...
private val chatCornerTileColors = Colors(container = AppBackground, content = AppOnSurfaceVariant)
private val chatCornerTileBorder = Border(
    idle = BorderStroke(2.dp, AppDimBorder),
    focused = BorderStroke(2.dp, NeonPurpleGradient),
)
private val chatCornerTileGlow = Glow(focusedColor = NeonPurpleGlow)
