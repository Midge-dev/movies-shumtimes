...
private val cardColors = Colors(container = AppSurfaceVariant, content = AppWhite)
private val cardBorder = Border(focused = BorderStroke(2.dp, NeonPurpleGradient))
private val cardGlow = Glow(focusedColor = NeonPurpleGlow)
